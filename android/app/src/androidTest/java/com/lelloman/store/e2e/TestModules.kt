...
class TestRemoteApiClient(
    ...
    override suspend fun acquireApk(packageName: String, versionCode: Int, idempotencyKey: String, purpose: com.lelloman.store.domain.model.AcquisitionPurpose): Result<com.lelloman.store.domain.model.ApkAcquisition> = runCatching {
